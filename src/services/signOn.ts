...
export const PageInfoFragmentDoc = gql`
  ...
  endCursor
    ...
    `;
export const CashItemInfoFragmentDoc = gql`
...
export const PositionInfoFragmentDoc = gql`
  ...
  isWhitelist
    ...
    `;
export const HoldingResInfoFragmentDoc = gql`
...
export const FactorValueItemInfoFragmentDoc = gql`
    fragment FactorValueItemInfo on FactorValueItem {
  min
  max
}
    `;
export const HistogramItemInfoFragmentDoc = gql`
...
export const FactorItemInfoFragmentDoc = gql`
...
export const FactorsTypeInfoFragmentDoc = gql`
...
export const UniverseInfoFragmentDoc = gql`
    fragment UniverseInfo on UniverseType {
  name
  country
}
    `;
export const BaseDateInfoFragmentDoc = gql`
    fragment BaseDateInfo on BaseDate {
  start
  end
}
    `;
export const ThemeStrategyTypeInfoFragmentDoc = gql`
...
export const MasterStrategyTypeInfoFragmentDoc = gql`
  ...
  simulationOption {
    ...
    ${BaseDateInfoFragmentDoc}`;
export const SectorIndustryStrategyTypeInfoFragmentDoc = gql`
  ...
  simulationOption {
    ...
    ${UniverseInfoFragmentDoc}
${BaseDateInfoFragmentDoc}`;
export const SimulationOptionInfoFragmentDoc = gql`
  ...
  tradingAmountLimit
    ...
    `;
export const ReturnSummaryTypeInfoFragmentDoc = gql`
  ...
  annualAvgVolatility
    ...
    `;
export const MyStrategyReturnSummaryItemInfoFragmentDoc = gql`
...
export const MyStrategyReturnSummaryTypeInfoFragmentDoc = gql`
...
export const SectorIndustrySummaryTypeInfoFragmentDoc = gql`
  ...
  info {
    ...
    `;
export const MyStrategyInfoFragmentDoc = gql`
...
export const ThemeStrategiesTypeInfoFragmentDoc = gql`
  ...
  themeExtractionDate
    ...
    ${UniverseInfoFragmentDoc}
${BaseDateInfoFragmentDoc}`;
export const MasterStrategyListTypeInfoFragmentDoc = gql`
  ...
  img
    ...
    `;
export const ReturnItemInfoFragmentDoc = gql`
    fragment ReturnItemInfo on ReturnItem {
  name
  value
}
    `;
export const ReturnInfoItemInfoFragmentDoc = gql`
...
export const ReturnChartItemInfoFragmentDoc = gql`
  ...
  benchmark {
    ...
    ${ReturnItemInfoFragmentDoc}`;
export const RiskAssessmentItemInfoFragmentDoc = gql`
  ...
  annualAvgVolatility
    ...
    `;
export const RiskAssessmentEtcItemInfoFragmentDoc = gql`
  ...
  infoRatio
    ...
    `;
export const ReturnRateInfoFragmentDoc = gql`
  ...
  half {
    ...
    ${ReturnItemInfoFragmentDoc}`;
export const DetailedStrategyTypeInfoFragmentDoc = gql`
  ...
  benchmarks
    ...
    ${ReturnRateInfoFragmentDoc}`;
export const DetailedMasterStrategyTypeInfoFragmentDoc = gql`
  ...
  benchmarks
    ...
    ${ReturnRateInfoFragmentDoc}`;
export const StrategyFactorStyleItemInfoFragmentDoc = gql`
    fragment StrategyFactorStyleItemInfo on StrategyFactorStyleItem {
  name
  value
}
    `;
export const StrategyFactorStyleInfoFragmentDoc = gql`
...
export const WeightItemInfoFragmentDoc = gql`
    fragment WeightItemInfo on WeightItem {
  name
  weight
}
    `;
export const MyReturnChartItemInfoFragmentDoc = gql`
  ...
  benchmark {
    ...
    ${ReturnItemInfoFragmentDoc}`;
export const SectorTypeInfoFragmentDoc = gql`
  ...
  industries {
    ...
    `;
export const ForwardSummaryInfoFragmentDoc = gql`
  ...
  gainOrLossExchange
    ...
    ${BaseDateInfoFragmentDoc}`;
export const SignOnDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    signOn(variables: SignOnMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SignOnMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SignOnMutation>(SignOnDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'signOn', 'mutation');
    }
  };
}
